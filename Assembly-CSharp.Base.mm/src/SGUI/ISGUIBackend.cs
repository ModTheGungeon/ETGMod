...
namespace SGUI {
    ...
    public interface ISGUIBackend {
        ...
        bool Button(SElement elem, Vector2 position, Vector2 size, string text, TextAnchor alignment = TextAnchor.MiddleCenter, Texture icon = null);
        bool Button(Rect bounds, string text, TextAnchor alignment = TextAnchor.MiddleCenter, Texture icon = null);
